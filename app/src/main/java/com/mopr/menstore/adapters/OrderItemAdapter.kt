...
class OrderItemAdapter(private val context: Context, private val orderItems: List<OrderItem>, private val products: List<Product>, private val productDetails: List<ProductDetail>, private val firstProductImages: List<ProductImage>): RecyclerView.Adapter<OrderItemAdapter.OrderItemViewHolder>(){
